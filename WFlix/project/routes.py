...
def send_notification(user_city):
    ...
    notification.notify(
        ...
        app_icon="C:\\Users\\abc\\Downloads\\rainy-weather.ico",
        timeout=10
    )
...
def news():
    if request.method == "POST":
        ...
        try:
            ...
            # Limit number of articles to 100
            ...
            return render_template("news.html", all_articles=all_articles, keyword=keyword)
        except Exception as e:
            error_message = "An error occurred while fetching news: " + str(e)
            return render_template("news.html", error_message=error_message)
        ...
        try:
            ...
            return render_template("news.html", all_articles=all_headlines)
        except Exception as e:
            error_message = "An error occurred while fetching news: " + str(e)
            return render_template("news.html", error_message=error_message)
